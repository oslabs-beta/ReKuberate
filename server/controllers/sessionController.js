...
var sessionController = {
    ...
    hasCookie: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var username, sqlQuery, data, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    err_1 = _a.sent();
                    return [2 /*return*/, next({
                            log: "error in hasCookie controller: ".concat(err_1),
                            status: 500,
